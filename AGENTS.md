...
- 2026-05-01: Added a global keyboard-dismiss wrapper in `lib/app.dart`. The app now unfocuses the active input when the user taps non-interactive space anywhere in the app, making it easier to hide the keyboard on iOS while preserving normal button/field interactions. Verified with `flutter analyze`.
